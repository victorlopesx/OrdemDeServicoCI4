<!DOCTYPE html>
	<html>
	  <head> 
		...
		<title> <?php echo $this->renderSection('title'); ?> - Ordem de Serviço</title>
    ...
    <!-- custom styles end -->
		...
		<div class="d-flex align-items-stretch">
		  ...
		  <nav id="sidebar">
			...
			<ul class="list-unstyled">
					...
					<li class="<?php echo (url_is('users*') ? 'active' : ''); ?>"><a href="<?php echo site_url('users'); ?>"> <i class="icon-user"></i>Usuários </a></li>
      ...
      <footer class="footer">
		...
		<script src="<?php echo site_url('assets/'); ?>vendor/popper.js/umd/popper.min.js"> </script>
		...
		<script src="<?php echo site_url('assets/'); ?>vendor/jquery-validation/jquery.validate.min.js"></script>
		<script src="<?php echo site_url('assets/'); ?>js/charts-home.js"></script>
		<script src="<?php echo site_url('assets/'); ?>js/front.js"></script>
